...
ActiveRecord::Schema.define(version: 2018_04_20_074426) do

  create_table "sales", force: :cascade do |t|
    t.decimal "price_xem", precision: 10, scale: 2, default: "0.0"
  ...
  create_table "shop_profiles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["shop_id"], name: "index_shop_profiles_on_shop_id"
  end
  ...
  create_table "shops", force: :cascade do |t|
    ...
    t.index ["unlock_token"], name: "index_shops_on_unlock_token", unique: true
  end

  create_table "xem_prices", force: :cascade do |t|
